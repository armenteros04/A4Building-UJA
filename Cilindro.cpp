...
Cilindro::Cilindro(float r, float h, int s) : radio(r), altura(h), segmentos(s) {
    construirMalla();
}
void Cilindro::construirMalla() {
    ...
    // Indices para construir la malla lateral sin el último segmento
